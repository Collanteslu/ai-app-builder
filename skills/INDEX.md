...
| `auth-implementation-patterns` | 3, 5 | Patrones de auth (JWT, OAuth, sesiones, RBAC) |
...
| `e2e-testing-patterns` | 5, 6 | Tests end-to-end |
| `error-handling-patterns` | 3, 5 | Manejo de errores robusto |
| `interaction-design` | 4 | Microinteracciones y motion |
| `javascript-testing-patterns` | 5, 6 | Tests unit/integración JS/TS |
...
| `playwright` | 5, 6 | E2E con Playwright |
| `postgresql-best-practices` | 3, 5 | Esquema y queries en PostgreSQL |
...
| `security-best-practices` | 3, 6 | Seguridad backend, validación de entrada |
| `security-review` | 3, 6 | Escáner de vulnerabilidades |
| `shadcn` | 4, 5 | Componentes shadcn/ui |
| `tailwindcss` | 4, 5 | Estilos utility-first |
| `testing` | 5, 6 | Buenas prácticas de test |
| `ui-design` | 4 | UI accesible y usable |
| `ux-design` | 0, 1, 4 | UX centrado en el usuario |
